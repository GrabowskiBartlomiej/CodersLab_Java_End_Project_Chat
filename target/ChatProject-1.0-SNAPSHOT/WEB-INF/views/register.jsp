...
<div class="wrapper">
    ...
    <div class="center">
        <div class="container">
            ...
            <p id="description">To sign-up for a free basic account please provide us with some basic information using
            ...
            <form class="form" id="form" method="post" onsubmit="return myFunction()" action="/register">
                ...
                <div>
                    <p class="password-help">Please enter your password, at least one lowercase, one uppercase
                        letter</p>
                    <p class="password-help">And between 6 and 20 characters</p>
                </div>

                <input type="password" id="re_password" class="re_password" name="re_password"
